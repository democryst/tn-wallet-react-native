...
exports.Hotpost = function (sourceID, sourceInitialBalance, destinationID,
  ...
  fetch('https://188.166.214.163/transactions/transfer'+'/'+sourceID+'/'+sourceInitialBalance+'/'+destinationID+'/'+destinationInitialBalance+'/'+amount+'/'+sourceRemain+'/'+destinationRemain)
}
